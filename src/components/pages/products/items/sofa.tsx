      ...
      <div className={styles.grid}>
        {filtered.map(sofa => (
          <div key={sofa.id} className={styles.card}>
            <button className={styles.wishBtn} onClick={() => handleAddToWishlist(sofa.id)} title="Wishlist"> {wished.has(sofa.id) ? "♥" : "♡"}</button>
            ...
            <div className={styles.cardBody}>
              ...
              <div className={styles.priceRow}>
                ...
                {pct(sofa) > 0 && (
                  <span className={styles.discount}>-{pct(sofa)}%</span>
                )}
              </div>
